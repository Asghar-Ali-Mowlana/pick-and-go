...
class _ReceiverTrackingState extends State<ReceiverTracking> {
  ...
  late bool pickupReqAccepted;
  late bool packagePickedUp;
  late bool packageDroppedOperationalCenter;
  late bool packageLeftOperationalCenter;
  late bool packageDelivered;
  ...
  getPackageStatus() async {
    await FirebaseFirestore.instance
        ...
        .then((DocumentSnapshot documentSnapshot) {
      if (documentSnapshot.exists) {
        pickupReqAccepted = documentSnapshot['pickupreqaccepted'];
        packagePickedUp = documentSnapshot['packagePickedUp'];
        packageDroppedOperationalCenter =
            documentSnapshot['packageDroppedOperationalCenter'];
        packageLeftOperationalCenter =
            documentSnapshot['packageLeftOperationalCenter'];
        packageDelivered = documentSnapshot['packageDelivered'];
      } else {
        print("The package document does not exist");
      }
    });
              ...
              title: pickupReqAccepted == false &&
                  ...
                  : pickupReqAccepted == true &&
                      ...
                      : pickupReqAccepted == true &&
                              ...
                              packageLeftOperationalCenter == false &&
                              packageDelivered == false
                          ? Text("Package pickedup")
                          : pickupReqAccepted == true &&
                                  packagePickedUp == true &&
                                  packageDroppedOperationalCenter == true &&
                                  packageLeftOperationalCenter == false &&
                                  packageDelivered == false
                              ...
                              : pickupReqAccepted == true &&
                                      packagePickedUp == true &&
                                      packageDroppedOperationalCenter == true &&
                                      packageLeftOperationalCenter == true &&
                                      packageDelivered == false
                                  ? Text("Package Left Operational Center")
                                  : pickupReqAccepted == true &&
                                          packagePickedUp == true &&
                                          packageDroppedOperationalCenter ==
                                              true &&
                  ...
                  builder: (BuildContext context) {
                    return Container(
                      ...
                      child: Center(
                        child: Padding(
                          padding:
                              const EdgeInsets.fromLTRB(48.0, 0.0, 0.0, 0.0),
                          child: Column(
                ...
                : StreamBuilder(
                    ...
                    builder: (BuildContext context,
                      ...
                      if (userDocument!['pickupreqaccepted'] == false &&
                          ...
                          userDocument['packageDroppedOperationalCenter'] ==
                              false &&
                          userDocument['packageLeftOperationalCenter'] ==
                              false &&
                            ...
                            setState(() {
                              ...
                              _markers.add(Marker(
                                ...
                                position: LatLng(userDocument['pickuplatitude'],
                                    userDocument['pickuplongitude']),
                                infoWindow:
                                    InfoWindow(title: 'Operation Center'),
                              ));
                              setPolylinesInMap(
                                  userDocument['driverlatitude'],
                                  userDocument['driverlongitude'],
                            ...
                            : GoogleMap(
                                ...
                                onMapCreated:
                                  ...
                                  _newMarkers.add(Marker(
                                    ...
                                    position: LatLng(operationalCenterLat,
